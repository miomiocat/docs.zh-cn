...
- Starrocks 支持 Hudi 表的查询类型有 Snapshot Queries 和 Read Optimized Queries (仅针对 MOR 表)，暂不支持 Incremental Queries。有关 Hudi 查询类型的说明，请参见 [Table & Query Types](https://hudi.apache.org/docs/next/table_types/#query-types)。。
